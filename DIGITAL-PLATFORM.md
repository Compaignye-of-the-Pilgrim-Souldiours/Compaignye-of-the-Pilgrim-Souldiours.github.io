...
7. Minute digital-asset ownership ([docs/governance/DIGITAL-ASSET-OWNERSHIP.md](docs/governance/DIGITAL-ASSET-OWNERSHIP.md)); align with draft By-law No. 3 in `documents/`.
