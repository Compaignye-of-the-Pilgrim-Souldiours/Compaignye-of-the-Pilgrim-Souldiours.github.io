...
|---|---|---|---|---|
| GitHub Organization | `pilgrim-souldiours` (working slug) | Prior or designated web admin | Second org owner | Create ASAP |
| Website repo | `pilgrim-souldiours.github.io` | Web admin | Second collaborator | |
| GitHub Pages | `https://pilgrim-souldiours.github.io/` | Web admin | Second owner | |
